...
public class FileUtil {
	 ...
	 * @return
	 */
	public static Integer getFileType(byte[] bytes) {
		try {
	...
	public static String uploadImage(MultipartFile imageFile) {
		...
		String fileName = FileUtil.generateImageFid(System.currentTimeMillis()) + "." + IOUtil.getFileSuffix(imageFile.getOriginalFilename());
		try {
