...
public class Select extends ArrayList {
	...
	public <T> Select(List<T> sourceList, String valueFieldName, String textFieldName) {
		List<SelectItemVO> list = SelectFactory.getSelectList(sourceList, valueFieldName, textFieldName);
