...
public class HttpClientReq {
	...
	private static HttpClientReq instance = new HttpClientReq();

	public static HttpClientReq getInstance() {
		return instance;
	}
	...
	private static RequestConfig getRequestConfig() {
		return RequestConfig.custom().setConnectTimeout(CONNECT_TIMEOUT).setSocketTimeout(CONNECT_TIMEOUT).setConnectionRequestTimeout(CONNECT_TIMEOUT).build();
	}
