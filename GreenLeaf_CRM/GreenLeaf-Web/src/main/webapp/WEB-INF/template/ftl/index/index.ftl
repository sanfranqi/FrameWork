					...
					<div class="portlet solid bordered light-grey">
						...
						<div class="portlet-body">
							<div id="site_statistics_loading">
								<img src="../../../fed/img/loading.gif" alt="loading"/>
							</div>
										...
										<div class="scroller" style="height: 290px;" data-always-visible="1" data-rail-visible1="1">
											<div class="row">
												<div class="col-md-6 user-info">
													<img alt="" src="../../../fed/img/avatar.png" class="img-responsive" />
													<div class="details">
														<div>
					...
					<div class="portlet">
						...
						<div class="portlet-body" id="chats">
							<div class="scroller" style="height: 435px;" data-always-visible="1" data-rail-visible1="1">
								<ul class="chats">
									<li class="in">
										<img class="avatar img-responsive" alt="" src="../../../fed/img/avatar1.jpg" />
										<div class="message">
									...
									<li class="out">
										<img class="avatar img-responsive" alt="" src="../../../fed/img/avatar2.jpg" />
										<div class="message">
											<span class="arrow"></span>
									...
									<li class="out">
										<img class="avatar img-responsive" alt="" src="../../../fed/img/avatar3.jpg" />
										<div class="message">
											<span class="arrow"></span>
