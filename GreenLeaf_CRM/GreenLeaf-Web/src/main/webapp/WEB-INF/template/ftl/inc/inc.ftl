...
<head>
	<meta charset="utf-8" />
	<title>${title!''} - CRM Template</title>
	...
	<link href="../../../fed/plugins/gritter/css/jquery.gritter.css" rel="stylesheet" type="text/css"/>
	<link href="../../../fed/plugins/bootstrap-daterangepicker/daterangepicker-bs3.css" rel="stylesheet" type="text/css" />
	<link href="../../../fed/plugins/fullcalendar/fullcalendar/fullcalendar.css" rel="stylesheet" type="text/css"/>
	<link href="../../../fed/plugins/jqvmap/jqvmap/jqvmap.css" rel="stylesheet" type="text/css"/>
	<link href="../../../fed/plugins/jquery-easy-pie-chart/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css"/>
	...
	<link href="../../../fed/css/pages/tasks.css" rel="stylesheet" type="text/css"/>
...
<body class="page-header-fixed">
	...
	<div class="header navbar navbar-inverse navbar-fixed-top">
		...
		<div class="header-inner">
			...
			<img src="../../../fed/img/logo.png" alt="logo" class="img-responsive" />
			</a>
			<!-- END LOGO -->
			<!-- BEGIN RESPONSIVE MENU TOGGLER --> 
			<a href="javascript:;" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
			<img src="../../../fed/img/menu-toggler.png" alt="" />
			</a> 
			...
			<ul class="nav navbar-nav pull-right">
						...
						<li>
							<ul class="dropdown-menu-list scroller" style="height: 250px;">
								<li>  
									...
									<span class="photo"><img src="./../../../fed/img/avatar2.jpg" alt=""/></span>
									<span class="subject">
								...
								<li>  
									<a href="inbox.html?a=view">
									<span class="photo"><img src="./../../../fed/img/avatar3.jpg" alt=""/></span>
									<span class="subject">
								...
								<li>  
									<a href="inbox.html?a=view">
									<span class="photo"><img src="./../../../fed/img/avatar1.jpg" alt=""/></span>
									<span class="subject">
				...
				<li class="dropdown user">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
					<img alt="" src="../../../fed/img/avatar1_small.jpg"/>
...
<#macro pageContent firstLevel='' secondLevel=''>
	<!-- BEGIN PAGE -->
			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<#if firstLevel??>
    						<li>
    							<a href="javascript:;">${firstLevel!''}</a>
						...
						<#if secondLevel??&&secondLevel!=''>
    						<li><a href="javascript:;">${secondLevel!''}</a></li>
						</#if>
						<li class="pull-right">
...
<#macro footer>
	...
	<script src="../../../fed/plugins/jquery-ui/jquery-ui-1.10.3.custom.min.js" type="text/javascript"></script>
	...
	<script src="../../../fed/plugins/jqvmap/jqvmap/jquery.vmap.js" type="text/javascript"></script>   
	<script src="../../../fed/plugins/jqvmap/jqvmap/maps/jquery.vmap.russia.js" type="text/javascript"></script>
	<script src="../../../fed/plugins/jqvmap/jqvmap/maps/jquery.vmap.world.js" type="text/javascript"></script>
	<script src="../../../fed/plugins/jqvmap/jqvmap/maps/jquery.vmap.europe.js" type="text/javascript"></script>
	<script src="../../../fed/plugins/jqvmap/jqvmap/maps/jquery.vmap.germany.js" type="text/javascript"></script>
	<script src="../../../fed/plugins/jqvmap/jqvmap/maps/jquery.vmap.usa.js" type="text/javascript"></script>
	<script src="../../../fed/plugins/jqvmap/jqvmap/data/jquery.vmap.sampledata.js" type="text/javascript"></script>  
	<script src="../../../fed/plugins/flot/jquery.flot.js" type="text/javascript"></script>
	<script src="../../../fed/plugins/flot/jquery.flot.resize.js" type="text/javascript"></script>
	<script src="../../../fed/plugins/jquery.pulsate.min.js" type="text/javascript"></script>
	<script src="../../../fed/plugins/bootstrap-daterangepicker/moment.min.js" type="text/javascript"></script>
	<script src="../../../fed/plugins/bootstrap-daterangepicker/daterangepicker.js" type="text/javascript"></script>     
	<script src="../../../fed/plugins/gritter/js/jquery.gritter.js" type="text/javascript"></script>
	<!-- IMPORTANT! fullcalendar depends on jquery-ui-1.10.3.custom.min.js for drag & drop support -->
	<script src="../../../fed/plugins/fullcalendar/fullcalendar/fullcalendar.min.js" type="text/javascript"></script>
	<script src="../../../fed/plugins/jquery-easy-pie-chart/jquery.easy-pie-chart.js" type="text/javascript"></script>
	<script src="../../../fed/plugins/jquery.sparkline.min.js" type="text/javascript"></script>  
